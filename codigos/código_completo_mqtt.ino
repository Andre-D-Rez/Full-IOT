...
const char* ssid = "REDE"; // Rede padrão do Wokwi
const char* password = "SENHA";        // Nenhuma senha
...
const char* topic_comando = "andre/esp32/componente/comando"; // Tópico para receber comandos
const char* topic_status = "andre/esp32/componente/status";   // Tópico para publicar o status
